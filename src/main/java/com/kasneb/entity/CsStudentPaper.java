...
public class CsStudentPaper implements Serializable {
    ...
    public CsStudentPaper() {
    }

    public CsStudentPaper(CpaPaper paper, Integer section, Integer part, String stream) {
        this.paper = paper;
