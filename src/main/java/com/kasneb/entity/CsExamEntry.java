...
@Entity
@Table(name = "cpsentt")
public class CsExamEntry implements Serializable {
    ...
    @OneToMany(mappedBy = "csExamEntry")
    private List<CsExamPaper> csExamPapers;
    ...
    public List<CsExamPaper> getCsExamPapers() {
        return csExamPapers;
    }

    public void setCsExamPapers(List<CsExamPaper> csExamPapers) {
        this.csExamPapers = csExamPapers;
    }
}
