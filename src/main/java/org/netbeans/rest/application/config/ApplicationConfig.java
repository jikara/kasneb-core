...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.kasneb.api.CentreRest.class);
        ...
        resources.add(com.kasneb.api.FeeRest.class);
        resources.add(com.kasneb.api.NationRest.class);
        resources.add(com.kasneb.api.ReceiptRest.class);
        resources.add(com.kasneb.api.RegistrationRest.class);
        resources.add(com.kasneb.api.StudentCoursePaperRest.class);
        resources.add(com.kasneb.api.ZoneRest.class);
